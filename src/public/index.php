...
$router->get('/admin/competences', 'AdminCompetenceController@index');
$router->get('/admin/competences/create', 'AdminCompetenceController@create');
$router->post('/admin/competences/store', 'AdminCompetenceController@store');
